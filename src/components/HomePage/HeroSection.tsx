...
const HeroSection = () => {
    return (
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="my-8">
            <span className="inline-block px-4 py-2 bg-purple-500 bg-opacity-20 border border-purple-500 border-opacity-30 rounded-full text-purple-300 text-sm font-medium mb-6">
              📚 Welcome to BookBazzar
            </span>
